...
Public Class PCONF002
    ...
    Private Sub PCONF002_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub llenarDW1()
        ...
        Dim comando1 As New SqlClient.SqlCommand("SELECT dbo.T_C_OC_105.N_OC_105, dbo.T_C_OC_105.F_ALTA_105, dbo.M_CONT_004.DESC_004, dbo.T_C_OC_105.USERG_105 FROM dbo.T_C_OC_105 INNER JOIN dbo.M_CONT_004 ON dbo.T_C_OC_105.CONT_105 = dbo.M_CONT_004.NCONT_004 WHERE (dbo.T_C_OC_105.TIPO_OC_105 = 2) AND (dbo.T_C_OC_105.ESTA_105 = 1)", con1)
        ...
        While lector1.Read
            ...
            d4 = MAIN.OBT_NOM_USER(lector1.GetValue(3))
            Me.DataGridView1.Rows.Add(d1, d2, d3, d4)
        End While
    ...
    Private Sub llenarDW2_estado1(ByVal nremi As Decimal)
        ...
        con1.Open()
        'creo el comando para pasarle los parametros
        Dim comando1 As New SqlClient.SqlCommand("SELECT dbo.T_D_OC_106.C_MATE_106, dbo.M_MATE_002.DESC_002, dbo.M_MATE_002.UNID_002, dbo.T_D_OC_106.CANT_106, dbo.T_D_OC_106.CANTE_106 FROM dbo.T_D_OC_106 INNER JOIN dbo.M_MATE_002 ON dbo.T_D_OC_106.C_MATE_106 = dbo.M_MATE_002.CMATE_002 WHERE (dbo.T_D_OC_106.N_OC_106 = @D1)", con1)
        'creo el lector de parametros
        ...
        While lector1.Read
            ...
            Me.DataGridView2.Rows.Add(mate, desc, u, soli)
        End While
        'ciero la conexion
        con1.Close()
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox1.CheckedChanged
        For i = 0 To Me.DataGridView2.RowCount - 1
            ...
            If Me.DataGridView2.Item(4, i).Value <> CheckBox1.Checked Then
                Me.DataGridView2.Item(4, i).Value = CheckBox1.Checked
            End If
        Next
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            res = MessageBox.Show("Esta por rechazar la OC N: " + nremito.ToString.PadLeft(8, "0") + vbCrLf + "¿Desea continuar?", "MADVE001", MessageBoxButtons.YesNo, MessageBoxIcon.Information)
    ...
    Public Sub APROBAR_ITME_OC()
        For i = 0 To Me.DataGridView2.RowCount - 1
            ...
            End If
        Next
        oc.aprobar_oc(nremito, 2, Date.Now, _usr.Obt_Usr)
    End Sub
