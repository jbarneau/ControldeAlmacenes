...
Public Class PCONF001
    ...
    Private Sub llenarDW1()
        ...
        Dim comando1 As New SqlClient.SqlCommand("SELECT dbo.T_C_OC_105.N_OC_105, dbo.T_C_OC_105.F_ALTA_105, dbo.T_C_OC_105.USERG_105, dbo.M_PROV_005.RAZO_005, dbo.T_C_OC_105.CONT_105 FROM dbo.T_C_OC_105 INNER JOIN dbo.M_PROV_005 ON dbo.T_C_OC_105.C_PROV_105 = dbo.M_PROV_005.CUIT_005 WHERE (dbo.T_C_OC_105.TIPO_OC_105 = 1) AND (dbo.T_C_OC_105.ESTA_105 = 1)", con1)
        ...
        While lector1.Read
            ...
            If lector1.GetValue(4) = "0" Then
                d5 = "SIN CONTRATO"
            Else
                d5 = oc.que_contrato(lector1.GetValue(4))
            End If
