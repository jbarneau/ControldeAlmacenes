...
Public Class ListadoMedLiberados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListadoMedLiberados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication3.ListadoMedLiberados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoMedLiberados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoMedLiberados = New ListadoMedLiberados()
        rpt.Site = Me.Site
        Return rpt
    End Function
