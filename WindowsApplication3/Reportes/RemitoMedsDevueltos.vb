...
Public Class RemitoMedsDevueltos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RemitoMedsDevueltos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication3.RemitoMedsDevueltos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemitoMedsDevueltos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemitoMedsDevueltos = New RemitoMedsDevueltos()
        rpt.Site = Me.Site
        Return rpt
    End Function
