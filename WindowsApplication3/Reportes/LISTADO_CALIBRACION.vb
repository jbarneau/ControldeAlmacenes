...
Public Class LISTADO_CALIBRACION
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LISTADO_CALIBRACION.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication3.LISTADO_CALIBRACION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLISTADO_CALIBRACION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LISTADO_CALIBRACION = New LISTADO_CALIBRACION()
        rpt.Site = Me.Site
        Return rpt
    End Function
