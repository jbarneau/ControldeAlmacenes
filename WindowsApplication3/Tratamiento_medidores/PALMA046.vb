...
#Region "FUNCIONES DE INICIO"
    Private Sub llenar_DS_OPERARIO()
        ...
        cnn2.Open()
        'GENERO UN ADAPTADOR
        Dim adaptadaor As New SqlCommand("SELECT M_PERS_003.NDOC_003 AS DNI, M_PERS_003.APELL_003 + N' ' + M_PERS_003.NOMB_003 AS NOMYAPE FROM T_MED_DEVO_113 INNER JOIN M_PERS_003 ON T_MED_DEVO_113.OPERA_113 = M_PERS_003.NDOC_003 GROUP BY M_PERS_003.NDOC_003, M_PERS_003.APELL_003 + N' ' + M_PERS_003.NOMB_003 ORDER BY NOMYAPE", cnn2)
    ...
    Private Sub llenar_DS_Familia()
        ...
        cnn2.Close()
        cbFamilia.DataSource = DS_deposito.Tables(" DET_PARAMETRO_802")
        cbFamilia.DisplayMember = "DESC_802"
        cbFamilia.ValueMember = "C_PARA_802"
        cbFamilia.Text = Nothing
    End Sub
    ...
    Private Sub llenar_table_base(ByVal DEPO As String)
        ...
        Try
            ...
            Dim adaptadaor As New SqlDataAdapter("SELECT T_MED_DEVO_113.NSERI_113, T_MED_DEVO_113.CMATE_113, T_MED_DEVO_113.POLIZA_113, T_MED_DEVO_113.OT_113, T_MED_DEVO_113.CONTRATO_113,  T_MED_DEVO_113.FCARGO_113, T_MED_DEVO_113.OPERA_113 FROM T_MED_DEVO_113 INNER JOIN T_PERMISO_FAMILIA_123 ON T_MED_DEVO_113.CMATE_113 = T_PERMISO_FAMILIA_123.CODMAT124 AND T_MED_DEVO_113.OT_113 = T_PERMISO_FAMILIA_123.OT124 WHERE (T_MED_DEVO_113.ESTADO_113 = 0) AND (T_MED_DEVO_113.FAMILIA_113 = 0) AND (T_MED_DEVO_113.OPERA_113 = @D1) AND (T_PERMISO_FAMILIA_123.FAMILIA124 = @D2) AND (T_MED_DEVO_113.NSERI_113<>'0') ORDER BY T_MED_DEVO_113.NSERI_113", cnn2)

            adaptadaor.SelectCommand.Parameters.Add(New SqlParameter("D1", DEPO))
            adaptadaor.SelectCommand.Parameters.AddWithValue("D2", cbFamilia.SelectedValue)
    ...
    Private Sub llenar_table_base()
        ...
        Try
            ...
            Dim adaptadaor As New SqlDataAdapter("SELECT T_MED_DEVO_113.NSERI_113, T_MED_DEVO_113.CMATE_113, T_MED_DEVO_113.POLIZA_113, T_MED_DEVO_113.OT_113, T_MED_DEVO_113.CONTRATO_113,  T_MED_DEVO_113.FCARGO_113, T_MED_DEVO_113.OPERA_113 FROM T_MED_DEVO_113 INNER JOIN T_PERMISO_FAMILIA_123 ON T_MED_DEVO_113.CMATE_113 = T_PERMISO_FAMILIA_123.CODMAT124 AND T_MED_DEVO_113.OT_113 = T_PERMISO_FAMILIA_123.OT124 WHERE (T_MED_DEVO_113.ESTADO_113 = 0) AND (T_MED_DEVO_113.FAMILIA_113 = 0) AND (T_PERMISO_FAMILIA_123.FAMILIA124 = @D1) AND (T_MED_DEVO_113.NSERI_113<>'0') ORDER BY T_MED_DEVO_113.NSERI_113", cnn2)
            adaptadaor.SelectCommand.Parameters.AddWithValue("D1", cbFamilia.SelectedValue)
            adaptadaor.Fill(DT_medidores)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        Finally
...
#End Region
    ...
    Private Sub cbFamilia_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbFamilia.SelectedIndexChanged
        If cbFamilia.ValueMember <> Nothing And cbFamilia.Text <> Nothing Then
            CBEQUIPO.Enabled = True
            ListBox1.Items.Clear()
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox1.KeyPress
        If Asc(e.KeyChar) = 13 Then
            ...
            Else
                Dim nmed As String = TextBox1.Text

                If val_medi_data(nmed) = True Then
                    'NUEVO
                    ListBox2.Items.Add(nmed)
                    cbFamilia.Enabled = False
                    CBEQUIPO.Enabled = False
                ...
                Else
                    ...
                    Else
                        If buscar_medidor(nmed) = True Then
                            Select Case estado
                                Case Is = 0
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "NO SE PUEDE PROCESAR EN DICHA FLIA ", "VER ESTADO", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                                Case Is = 1
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "SE ENCUENTRA EN EL CAJON: " + cajon, "MEDIDOR EN CAJON " + cajon, MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                                Case Is = 2
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "SE ENCUENTRA REMITO: " + nremitoD, "MEDIDOR YA ENCONTRADO", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                                Case Is = 8
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "SE ENCUENTRA EXTRAVIADO" + vbCrLf + "CONSULTE CON EL ADMINISTRADOR", "MEDIDOR EXTRAVIADO", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                                Case Is = 9
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "SE ENCUENTRA EN CUSTODIA", "MEDIDOR EN CUSTODIA", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                                Case Is = 10
                                    MessageBox.Show("EL MEDIDOR Nº: " + nmed + vbCrLf + "NO LO SOLICITA EL SISTEMA", "MEDIDOR NO SOLICITADO", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                            End Select
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        If ComboBox3.Text <> Nothing Then
            ...
            End If
            familia = cbFamilia.SelectedValue
            nomfamilia = cbFamilia.Text
            pantalla.TOMAR(_DEPOSITO, cbFamilia.SelectedValue, cbFamilia.Text)
            pantalla.ShowDialog()
            If pantalla.LEERRESPUESTA = True Then
                ...
                If familia = 9 Then
                    For i = 0 To ListBox2.Items.Count - 1
                        medidor = ListBox2.Items(i).ToString
    ...
    Private Function verificarOCmed(ByVal medidor As String) As Boolean
        ...
        Try
            cnn1.Open()
            'Creamos el comando para crear la consulta
            Dim Comando As New SqlClient.SqlCommand("SELECT TIPO_TRAB900 FROM C900_TAREAS WHERE (NMEDIDOR900 = @D1) AND (TIPO_TRAB900 = N'OC') AND (FE_EMISION900 > GETDATE() - 30) ", cnn1)
            'Ejecutamos el commnad y le pasamos el parametro
    ...
    Public Sub ENVIAR_MENSAJE(ByVal BODY As String)
        ...
        _mensage.To.Add("control@exgadetsa.com.ar,calidad@exgadetsa.com.ar,almacenes@exgadetsa.com.ar")
    ...
    Public Sub ENVIAR_MENSAJEOC(ByVal BODY As String)
        ...
        _Smtp.EnableSsl = False
        'configuracion del mensaje
        _mensage.To.Add("calidad@exgadetsa.com.ar,control@exgadetsa.com.ar,almacenes@exgadetsa.com.ar")
        '_mensage.To.Add("frozenmuter@exgadetsa.com.ar")
    ...
    Private Function buscar_sap(ByVal medidor As String)
        Dim resp As String = ""
        Dim cnn1 As SqlConnection = New SqlConnection(conexion)
        'Abrimos la conexion
        cnn1.Open()
    ...
    Private Sub EnviarPorMail(ByVal lista As List(Of Clase_med_retirar))
        ...
        _Smtp.EnableSsl = False
        'configuracion del mensaje
        _mensage.To.Add("almacenes@exgadetsa.com.ar,control@exgadetsa.com.ar,calidad@exgadetsa.com.ar")
