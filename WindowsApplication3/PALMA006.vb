...
Public Class PALMA006
    ...
    Dim _Nremito As Decimal
    Private _FECHA As Date
    Private MENSAJE As New Clase_mensaje
    Private Metodos As New Clas_Almacen
    Private Medidor As New Clas_Medidor
    Private _CantItem As Integer = 0
    Private Sub PALMA006_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
                            ...
                            If Metodos.Tiene_Decimal(_MATERIAL, var) = True Then
                                ...
                                If CDec(var) > 0 Then
                                    ...
                                    If CDec(var) <= CDec(txtDisponible.Text) Then
                                        If Medidor.SERIALIZADO(_MATERIAL, _ALMACEN) = True Then
        ...
        Try
            If DataGridView1.RowCount > 0 Then
                ...
                For i = 0 To Me.DataGridView1.Rows.Count - 1
                    ...
                    Metodos.Grabar_Trans(_Nremito, _FECHA, _MATERIAL, _DEPOSITO, _ALMACEN, 2, _FECHA, 0, "", 1, _CANT, 0, _usr.Obt_Usr, "", "")
                Next
                'equipo
    ...
    Private Sub llenar_DS_MATERIAL(ByVal a As String)
        ...
        cnn2.Open()
        'GENERO UN ADAPTADOR
        Dim adaptadaor As New SqlClient.SqlDataAdapter("SELECT T_ALMA_103.C_MATE_103 as cod, M_MATE_002.DESC_002 as des FROM T_ALMA_103 INNER JOIN M_MATE_002 ON T_ALMA_103.C_MATE_103 = M_MATE_002.CMATE_002 WHERE (T_ALMA_103.ESTA_103 = 1) AND (T_ALMA_103.C_ALMA_103 = @D1) AND (M_MATE_002.TIPO_002 = 2) AND (T_ALMA_103.N_CANT_103 > 0) order by M_MATE_002.DESC_002", cnn2)
        'LLENO EL ADAPTADOR CON EL DATASET
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        R1_T1 = "TIPO DE MOVIMIENTO: ENTREGA DE INDUMENTARIA"
        R1_T2 = ""
