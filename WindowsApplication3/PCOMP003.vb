...
Public Class PCOMP003
    ...
    Private Sub DataGridView1_DoubleClick1(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        If DataGridView1.RowCount <> 0 Then
            ...
            _NPETICION = Me.DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value
            _FECHA = Me.DataGridView1.Item(1, DataGridView1.CurrentRow.Index).Value
            _FAPROBADA = Me.DataGridView1.Item(3, DataGridView1.CurrentRow.Index).Value
            _PROVEEDOR = Me.DataGridView1.Item(5, DataGridView1.CurrentRow.Index).Value
            _CONTRATO = Me.DataGridView1.Item(6, DataGridView1.CurrentRow.Index).Value
    ...
    Private Sub llenarDW2_estado2y3(ByVal nremi As Decimal)
        ...
        con1.Open()
        'creo el comando para pasarle los parametros
        Dim comando1 As New SqlClient.SqlCommand("SELECT dbo.T_D_OC_106.C_MATE_106, dbo.M_MATE_002.DESC_002, dbo.M_MATE_002.UNID_002, dbo.T_D_OC_106.CANT_106, dbo.T_D_OC_106.CANTE_106 FROM dbo.T_D_OC_106 INNER JOIN dbo.M_MATE_002 ON dbo.T_D_OC_106.C_MATE_106 = dbo.M_MATE_002.CMATE_002 WHERE (dbo.T_D_OC_106.N_OC_106 = @D1) and (dbo.T_D_OC_106.CONF_106 = 1) ", con1)
        'creo el lector de parametros
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        For I = 0 To DataGridView2.RowCount - 1
            ...
            e.Graphics.DrawString(Me.DataGridView2.Item(3, I).Value.ToString, New Font("ARIAL", 11, FontStyle.Regular), Brushes.Black, 730, LINEA)
            LINEA += SALTO
        Next
