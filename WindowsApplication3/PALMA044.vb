...
#Region "funciones"
    ...
    Private Function buscar_medidor(ByVal medidor As Decimal) As Boolean
        ...
        If Dusrs.Read.ToString Then
            Try
                ...
                userCargo = OBT_NOM_USER(Dusrs.GetValue(2))
                almacen = Dusrs.GetValue(3)
                ot = Dusrs.GetValue(4)
                codmate = Dusrs.GetValue(5)
                poliza = Dusrs.GetValue(6)
                contrato = ContratoMed(Dusrs.GetValue(7))
    ...
    Private Sub llenar_datos()
        If IsNumeric(txtmedidor.Text) And txtmedidor.Text <> Nothing Then
...
#End Region
    ...
    Private Sub Lcod_DoubleClick(sender As Object, e As System.EventArgs) Handles Lcod.DoubleClick
        ...
        End If
    End Sub
    Public Sub ACTUALIZAR_MEDIDOR(MEDIDOR As Decimal, COD As String)
    ...
    Private Sub txtInformado_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtInformado.TextChanged
